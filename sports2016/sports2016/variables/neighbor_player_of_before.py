# -*- coding: utf-8 -*-
"""
This file get before neighbor player of attacker from one frame data.
"""

from data.sports_dataset_frame import SportsDatasetFrame

class NeighborPlayerOfBefore:
    """
    NeighborPlayerOfBefore
    トラッキングデータの座標に基づき，ボール保持プレイヤーの前方の状況を出力する。
    """
    NONE_EXIST = 0
    HOME_EXIST = 1
    AWAY_EXIST = 2
    ...
    def __calculate_direction(x_1, y_1, x_2, y_2):
        return (x_2 - x_1) >= 0 and abs(y_2 - y_1) <= abs(x_2 - x_1)
